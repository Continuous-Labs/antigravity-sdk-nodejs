...
This example demonstrates how to equip an agent with a custom TypeScript function as
a tool.

## Defining and Using a Custom Tool

To create a custom tool, define a TypeScript function with a clear docstring. The
